    ...
    public class GatewaysController : ControllerBase
    {
        ...
        private static IEnumerable<CachedBeacon> GetBeacons()
        {
            ...
            return new List<CachedBeacon>()
            {
                ...
                new CachedBeacon { Mac = "FE-BB-DE-77-08-D5", GwTopic = "gp1/250", Distance = 2.0, GwMac = "C4-4F-33-6B-DD-99", TimeStamp = timeStamp },
                new CachedBeacon { Mac = "E9-E1-79-33-78-8F", GwTopic = "gp1/202", Distance = 2.2, GwMac = "8C-AA-B5-97-E1-FC", TimeStamp = timeStamp2 },
                new CachedBeacon { Mac = "FE-BB-DE-77-08-D5", GwTopic = "gp1/250", Distance = 0.5, GwMac = "C4-4F-33-6B-DD-99", TimeStamp = timeStamp2 },
            };
        }
